...
public interface CitaRepo extends JpaRepository<Cita, Integer> {
        ...
        // Seleccionar las citas completadas de un paciente por el nombre del medico y
        // fecha
        @Query("select c from Cita c where c.paciente.codigo = :codigoPaciente and c.estadoCita.estado = 'COMPLETADA' "
        ...
        // List<Cita> findAllByMedico_IdAndFechaGreaterThanEqual(int codigoMedico,
        // LocalDate fecha);
