...
public class AdministradorController {
    ...
    public ResponseEntity<MensajeDTO<String>> crearMedico(@Valid @RequestBody RegistroMedicoDTO medico)
            throws Exception {
    ...
    public ResponseEntity<MensajeDTO<String>> actualizarMedico(@Valid @RequestBody DetalleMedicoDTO medicoDTO)
            throws Exception {
    ...
    public ResponseEntity<MensajeDTO<String>> responderPQRS(@Valid @RequestBody RespuestaAdminDTO respuestaAdminDTO)
            throws Exception {
