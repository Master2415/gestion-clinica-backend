...
public class MedicoServicioImpl implements MedicoServicio {
    ...
    public List<ConsultaDTO> listarCitasPendientes(int codigoMedico) throws Exception {
        ...
        List<Cita> citasMedico = citaRepo.findAllByMedicoCodigoAndFechaCitaGreaterThanEqual(codigoMedico,
                LocalDateTime.now());
    ...
    public int atenderCita(RegistroAtencionDTO registroAtencionDTO) throws Exception {
        ...
        if (cita.isEmpty()) {
            ...
            throw new Exception(
                    "La cita no se puede atender dado que la fecha de atención es: " + cita.get().getFechaCita());
        }
        ...
        EstadoCita estadoFinalizada = estadoCitaRepo.findById(3)
                .orElseThrow(() -> new Exception("Estado FINALIZADA no encontrado")); // Assuming 3 is FINALIZADA
        buscado.setEstadoCita(estadoFinalizada);
    ...
    public int agendarDiaLibre(DiaLibreDTO diaLibreDTO) throws Exception {
        ...
        Optional<DiaLibre> diaLibre = diaLibreRepo
                .findByMedico_CodigoAndFechaGreaterThanEqual(diaLibreDTO.codigoMedico(), LocalDate.now());
    ...
    public DetalleAtencionMedicaDTO verDetalleAtencion(int codigoCita) throws Exception {
        ...
        return new DetalleAtencionMedicaDTO(
                ...
                atencionBuscada.getCita().getMedico().getEspecialidad(),
